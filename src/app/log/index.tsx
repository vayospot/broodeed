    ...
    <View style={[tw`flex-1`, { backgroundColor: colors.background }]}>
            ...
            <View
              ...
              style={[
                tw`h-1 rounded-full`,
                {
                  ...
                  backgroundColor:
                    index <= currentStep ? colors.primary : colors.divider,
                },
              ]}
            />
          ))}
      ...
      >
        ...
        <View style={[tw`flex-1 items-center justify-center px-6`, { width }]}>
          ...
          <TextInput
            style={[
              tw`text-5xl font-bold text-center p-4 rounded-2xl w-48`,
        ...
        {selectedFlock?.type === "layer" && (
          ...
          >
            ...
            <Text
              style={[tw`text-center mb-8`, { color: colors.textSecondary }]}
            >
              {steps[2].subtitle}
            </Text>
